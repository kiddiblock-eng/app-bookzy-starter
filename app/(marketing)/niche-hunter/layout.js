export const metadata = {
  ...
  keywords: [
    "trouver niche rentable", "analyseur niche gratuit", "idées business digital",
    "niche hunter ebook", "analyser concurrence niche", "business en ligne rentable",
    "outil recherche niche", "meilleure niche infoproduit",
  ],
  openGraph: {
    title: "Niche Hunter : Trouvez Votre idée eBook Rentable Instantanément",
    description: "Analyseur gratuit de niches eBook : volume de recherche, concurrence, potentiel de revenus.",
    url: "https://www.bookzy.io/niche-hunter",
    type: "website",
    images: [{ url: "/screenshots/niche-hunter.png", width: 1200, height: 630, alt: "Niche Hunter - Analyseur de Niches Gratuit" }],
  },
  twitter: {
    ...
    images: ["/screenshots/niche-hunter.png"],
  },
  alternates: { canonical: "https://www.bookzy.io/niche-hunter" },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "screenshot": "https://www.bookzy.io/screenshots/niche-hunter.png"
          })
        }}
      />
      {children}
