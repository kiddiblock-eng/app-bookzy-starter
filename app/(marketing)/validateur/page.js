...
function ScoreIllustration() {
  ...
  const color = score >= 80 ? '#10b981' : score >= 60 ? '#059669' : '#f59e0b';
      ...
      {phase === 1 && (
        <div style={{ animation: 'fade-in-up 0.4s ease' }}>
          {[
            ...
            { label: 'Revenus estimés', val: '180K FCFA/mois', color: '#059669' },
            { label: 'Annonceurs FB actifs', val: '14 annonceurs', color: '#059669' },
          ].map((item, i) => (
    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-[#F5F2ED]/90 backdrop-blur-md border-b border-[#C8BFB0]" : "bg-transparent"}`}>
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-16 md:h-20">
        <Link href="/" className="flex items-center gap-2.5">
          ...
          <div className="flex flex-col leading-none">
            ...
            <span className="text-[9px] font-black uppercase tracking-[0.2em] text-emerald-600">Validateur d'idée</span>
          </div>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <Link href="/auth/register" className="inline-flex items-center gap-2 px-6 py-2.5 bg-emerald-600 text-white font-black rounded-xl hover:bg-emerald-700 transition-colors text-xs uppercase tracking-widest">
      ...
      {open && (
        <div className="md:hidden bg-[#F5F2ED] border-t border-[#C8BFB0] px-6 py-6 flex flex-col gap-4">
          ...
          <Link href="/auth/register" className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-emerald-600 text-white font-black rounded-xl text-xs uppercase tracking-widest mt-2">
            Valider mon idée <ArrowRight className="w-3.5 h-3.5" />
          </Link>
        </div>
      )}
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 text-center lg:text-left">
            ...
            <h1 className="font-black text-neutral-900 tracking-tighter leading-[0.88] mb-6" style={{ fontSize: "clamp(3rem, 9vw, 6.5rem)" }}>
              ...
              <span className="text-emerald-600">se vendre ?</span>
            </h1>
            ...
            <p className="text-neutral-400 text-xs uppercase tracking-[0.25em] font-bold mb-10">Facebook Ads Library · Google Trends · Gemini AI · Données réelles</p>
            <div className="flex flex-col sm:flex-row items-center lg:items-start gap-4">
              <Link href="/auth/register" className="inline-flex items-center gap-2 px-8 py-4 bg-emerald-600 text-white font-black rounded-xl hover:bg-emerald-700 transition-colors text-sm uppercase tracking-widest">
                Valider gratuitement <ArrowRight className="w-4 h-4" />
              </Link>
              <a href="#rapport" onClick={e => { e.preventDefault(); document.getElementById("rapport")?.scrollIntoView({ behavior: "smooth" }); }} className="inline-flex items-center gap-2 px-8 py-4 border border-[#C8BFB0] text-neutral-700 font-bold rounded-xl hover:border-neutral-400 transition-colors text-sm uppercase tracking-widest">
                Voir un rapport
              </a>
            </div>
          </div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            { icon: "🤖", color: '#059669', title: "Gemini IA", desc: "On passe toutes les données à Gemini. L'IA calcule le score final, estime les revenus, identifie le niveau de concurrence, recommande les pays cibles et suggère un angle unique pour se différencier." },
          ].map((item, i) => (
    ...
    <section id="workflow" className="bg-[#F5F2ED] py-24 px-6 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        <div className="mb-14 pb-10 border-b border-[#C8BFB0]">
          <p className="text-xs font-black uppercase tracking-[0.3em] text-neutral-400 mb-3">Le flow</p>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            {
              num: "01", dark: false, accent: '#059669',
            ...
            {
              num: "02", dark: true, accent: '#059669',
            ...
            {
              num: "03", dark: false, accent: '#059669',
    ...
    <section id="rapport" className="bg-[#EDE8E0] py-24 px-6 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        <div className="mb-12 pb-8 border-b border-[#C8BFB0]">
          <p className="text-xs font-black uppercase tracking-[0.3em] text-neutral-400 mb-3">Le rapport</p>
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
            <h2 className="text-4xl md:text-5xl font-black text-neutral-900 tracking-tight">
              Ce que vous recevez<br />en 30 secondes.
            </h2>
            <p className="text-neutral-500 text-sm md:max-w-xs">Le rapport complet est réservé aux abonnés. Les non-abonnés voient le score et le verdict — le reste est flouté.</p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <div className="space-y-3">
              {[
                ...
                { icon: "🔑", title: "Mots-clés + Audience", desc: "Les mots-clés détectés et le profil de l'audience cible.", preview: <div className="mt-2 flex flex-wrap gap-1.5">{['marketing digital', 'ebook whatsapp', 'business ligne'].map(k => <span key={k} className="text-[10px] px-2 py-1 bg-neutral-100 text-neutral-600 rounded-full font-bold">{k}</span>)}</div> },
              ].map((item, i) => (
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="w-2 h-2 rounded-full bg-emerald-500" />
              <span className="text-xs font-black uppercase tracking-widest text-emerald-700">Réservé aux abonnés</span>
            </div>
            <div className="space-y-3">
              {[
        ...
        <div className="mt-8 bg-emerald-50 border border-emerald-200 rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
            <p className="font-black text-emerald-900 text-base">Le rapport complet avec ton abonnement</p>
            <p className="text-emerald-600 text-sm mt-0.5">3 analyses gratuites par jour incluses, puis quelques ebooks au-delà du quota.</p>
          </div>
          <Link href="/auth/register" className="flex-shrink-0 inline-flex items-center gap-2 px-6 py-3 bg-emerald-600 text-white font-black rounded-xl text-xs uppercase tracking-widest hover:bg-emerald-700 transition-colors">
...
function Comparatif() {
  return (
    <section className="bg-[#F5F2ED] py-24 px-6 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        <div className="mb-12 pb-8 border-b border-[#C8BFB0]">
          <p className="text-xs font-black uppercase tracking-[0.3em] text-neutral-400 mb-3">Avant / Après</p>
          <h2 className="text-4xl md:text-5xl font-black text-neutral-900 tracking-tight">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-white border-2 border-red-200 rounded-2xl overflow-hidden">
            <div className="bg-red-50 px-6 py-4 border-b border-red-200">
              <p className="font-black text-neutral-900 text-sm uppercase tracking-wider">Sans le Validateur</p>
              <p className="text-red-500 text-xs font-bold mt-0.5">Vous pariez à l'aveugle</p>
            </div>
            <div className="p-6 space-y-3">
              {[
                "Tu génères un ebook entier à l'aveugle",
                "Tu ne sais pas si quelqu'un en veut",
                "Tu lances sur une niche saturée sans le savoir",
                "Tu cibles le mauvais pays, les mauvaises personnes",
                "0 vente. Un ebook gaspillé.",
              ].map((item, i) => (
          ...
          <div className="bg-white border-2 border-emerald-300 rounded-2xl overflow-hidden">
            <div className="bg-emerald-600 px-6 py-4 border-b border-emerald-700">
              ...
              <p className="text-emerald-200 text-xs font-bold mt-0.5">Vous créez en sachant que ça vend</p>
            </div>
            <div className="p-6 space-y-3">
              {[
                "Tu valides ton idée en 30s avant de te lancer",
                "Score 82/100 → tu sais que c'est rentable",
                "Saturation 3/10 → concurrence faible, opportunité réelle",
                "Côte d'Ivoire + Sénégal → tu cibles les bons pays",
                "Tu crées l'ebook avec confiance. Tu vends.",
              ].map((item, i) => (
                <div key={i} className="flex items-start gap-3">
        ...
        <div className="mt-6 bg-neutral-900 rounded-2xl p-6 text-center">
          <p className="text-white font-black text-lg">Valide d'abord. Crée ensuite.</p>
          <p className="text-white/50 text-sm mt-1">Le Validateur te dit en 30s si ça vend, avant de créer un ebook qui resterait sur l'étagère.</p>
        </div>
      </div>
    </section>
  );
  ...
  return (
    <section className="bg-[#EDE8E0] py-24 overflow-hidden relative">
      ...
      <div className="relative z-10 mb-12 px-6 text-center">
        ...
        <h2 className="text-4xl md:text-5xl font-black text-neutral-900 tracking-tight">Ils ont validé. Ils ont vendu.</h2>
      </div>
      {[0, 1].map(row => (
          ...
          {DOUBLED.map((t, i) => (
            <div key={i} className="w-80 flex-shrink-0 bg-white border border-[#C8BFB0] rounded-2xl p-6">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="ml-auto text-xs font-black text-emerald-600">{t.result}</span>
              </div>
  ...
  return (
    <section id="pricing" className="bg-[#F5F2ED] py-24 px-6 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        <p className="text-xs font-black uppercase tracking-[0.3em] text-neutral-400 mb-3">Pour qui c'est</p>
        <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight text-neutral-900 mb-5">
          Valide ton idée,<br />
          <span className="text-[#059669]">puis crée ton ebook.</span>
        </h2>
        <p className="text-neutral-500 text-base md:text-lg max-w-xl mx-auto mb-10 leading-relaxed">
          Le Validateur d'idée est inclus dès ton inscription : tu obtiens le score et le verdict en 30 secondes. Le rapport complet et la création d'ebooks t'attendent dans ton espace.
        </p>
        <div className="grid sm:grid-cols-3 gap-4 mb-10 text-left">
          {[
            { title: "Score d'idée", desc: "Le score sur 100 et le verdict, dès le départ." },
            { title: "Rapport complet", desc: "Revenus estimés, pays cibles et angle unique." },
            { title: "Création d'ebook", desc: "Génère ton ebook prêt à vendre en quelques clics." },
          ].map((c) => (
            <div key={c.title} className="bg-white border border-[#C8BFB0] rounded-2xl p-5">
              <div className="w-9 h-9 rounded-xl bg-[rgba(5,150,105,0.12)] flex items-center justify-center mb-3">
                <Check className="w-4 h-4 text-[#059669]" />
              </div>
              <p className="font-extrabold tracking-tight text-neutral-900 text-sm mb-1">{c.title}</p>
              <p className="text-xs text-neutral-500 leading-relaxed">{c.desc}</p>
            </div>
          ))}
        </div>
        <Link href="/auth/register" className="inline-flex items-center gap-2 px-10 py-4 bg-neutral-900 text-white font-extrabold tracking-tight rounded-full hover:bg-neutral-800 transition-colors text-sm uppercase">
          Créer mon ebook <ArrowRight className="w-4 h-4" />
        </Link>
        <p className="mt-5 text-center text-xs text-neutral-400 flex items-center justify-center gap-2">
          <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 inline-block" />
          Validateur d'idée inclus · Sans carte bancaire pour démarrer
        </p>
      </div>
    </section>
  );
...
function FAQ() {
  ...
  const faqs = [
    ...
    { q: "Combien d'analyses puis-je faire ?", a: "Avec un abonnement, tu as un quota d'analyses gratuites par jour. Au-delà du quota, chaque analyse supplémentaire est décomptée de ton crédit d'ebooks. Sans abonnement, tu vois uniquement le score et le verdict — le rapport complet nécessite un abonnement." },
    ...
    { q: "Mes ebooks restants expirent-ils ?", a: "Non. Tes ebooks s'accumulent et n'expirent jamais. Même si ton abonnement expire, tes ebooks restants sont conservés." },
  ];
          ...
          {faqs.map((faq, i) => (
            <div key={i} className="bg-white border border-[#D6CFC4] rounded-xl overflow-hidden">
              <button onClick={() => setOpenIdx(openIdx === i ? -1 : i)} className="w-full flex items-center justify-between p-5 text-left gap-4">
                ...
                <ChevronDown className={`w-5 h-5 flex-shrink-0 transition-transform duration-200 ${openIdx === i ? "rotate-180 text-emerald-600" : "text-neutral-300"}`} />
              </button>
...
function CTAFinal() {
  return (
    <section className="bg-neutral-900 py-24 px-6 relative overflow-hidden">
      <div className="absolute inset-0 opacity-[0.04] pointer-events-none" style={{ backgroundImage: GRAIN, backgroundRepeat: "repeat", backgroundSize: "128px" }} />
      <div className="absolute top-0 right-0 w-64 h-64 rounded-full bg-emerald-600/10 blur-3xl pointer-events-none" />
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        <p className="text-xs font-black uppercase tracking-[0.3em] text-white/20 mb-6">30 secondes · Données réelles · Avant de créer</p>
        <h2 className="font-black text-white tracking-tight leading-[0.9] mb-6" style={{ fontSize: "clamp(2.5rem, 7vw, 5rem)" }}>
          Arrêtez de créer<br />
          <span className="text-emerald-400">sans savoir si ça vend.</span>
        </h2>
        <p className="text-white/40 text-lg max-w-xl mx-auto mb-12">30 secondes. Tu sais exactement si ton idée va se vendre — avant de créer ton ebook.</p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link href="/auth/register" className="inline-flex items-center gap-2 px-10 py-4 bg-emerald-600 hover:bg-emerald-700 text-white font-black rounded-xl transition-colors text-sm uppercase tracking-widest">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-12">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-neutral-500 leading-relaxed">Validez vos idées. Créez des ebooks rentables.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2 text-sm text-neutral-500"><span className="w-1.5 h-1.5 bg-emerald-500 rounded-full" />Support 7j/7</li>
