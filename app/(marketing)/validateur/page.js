...
function FAQ() {
  ...
  const faqs = [
    ...
    { q: "Combien d'analyses puis-je faire ?", a: "Avec une offre Créateur ou Pro, tu as un quota d'analyses gratuites chaque semaine. Sans offre, tu vois uniquement le score et le verdict — le rapport complet nécessite une offre." },
