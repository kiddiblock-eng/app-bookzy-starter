...
export default function Hero() {
  return (
    <section className="relative bg-white pt-36 sm:pt-48 pb-24 sm:pb-32">
      <div className="max-w-3xl mx-auto px-5 text-center">
        {/* Preuve sociale humaine (pas de badge "IA") */}
        <motion.div variants={fadeUp} custom={0} initial="hidden" animate="show" className="flex items-center justify-center gap-2.5 mb-9">
        ...
        <motion.h1 variants={fadeUp} custom={1} initial="hidden" animate="show"
          className="text-[36px] leading-[1.06] sm:text-[64px] sm:leading-[1.03] font-bold tracking-tight text-neutral-900">
          Déléguez la rédaction et le design de votre ebook,
        ...
        <motion.p variants={fadeUp} custom={2} initial="hidden" animate="show"
          ...
          Bookzy écrit, designe et met en forme votre prochain ebook. Un résultat plus pro que 99 % du marché, sans passer des heures à rédiger ou à mettre en page.
        </motion.p>

        <motion.div variants={fadeUp} custom={3} initial="hidden" animate="show" className="mt-9">
