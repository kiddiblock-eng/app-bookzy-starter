...
const ROTATE = ["en 1 min", "pour vendre", "pour apprendre", "pour partager"];
const ACCENT = "#5f7aa6";
...
function RotatingWord() {
  ...
  // Bloc pleine largeur + texte centré → le mot pivote au centre sans décaler le titre.
  return (
    <span className="block text-center" style={{ color: ACCENT }}>
  ...
  return (
    ...
    >
      <motion.div animate={{ y: [0, c.float, 0] }} transition={{ duration: 4.5, repeat: Infinity, ease: "easeInOut" }}>
        <div className="w-[152px] sm:w-[180px] rounded-xl overflow-hidden shadow-[0_24px_50px_-12px_rgba(0,0,0,0.35)] border border-black/5" style={{ aspectRatio: "3/4.2", background: c.grad }}>
    ...
    <section className="relative overflow-hidden bg-white pt-28 sm:pt-36 pb-20 sm:pb-28">
      ...
      <div className="max-w-3xl mx-auto px-5 text-center">
        ...
        <motion.h1 variants={fadeUp} custom={1} initial="hidden" animate="show"
          ...
          L'IA qui écrit et designe ton ebook pro
          <RotatingWord />
        </motion.h1>
        ...
        <motion.div variants={fadeUp} custom={3} initial="hidden" animate="show" className="mt-8 flex justify-center">
          <Link href="/auth/register"
            className="group inline-flex items-center gap-2 px-7 py-4 bg-neutral-900 text-white text-sm font-semibold rounded-full hover:bg-neutral-800 transition-colors shadow-lg shadow-neutral-900/10">
