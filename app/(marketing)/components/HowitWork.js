              ...
              <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
                <div>
                  ...
                  <p className="mt-4 text-slate-500 text-sm sm:text-base max-w-md">
                    Deux parcours selon ta situation : que tu aies déjà une idée ou que tu cherches encore, choisis le tien.
                  </p>
                </div>
                ...
                <div key={`${mode}-${i}`} className="relative">
                  ...
                  <div className="rounded-2xl border border-[#E8E8E8] bg-white hover:border-slate-300 hover:shadow-md transition-all duration-300 p-6 h-full flex flex-col gap-4">
                    <div className="flex items-start justify-between">
                      <span className="text-6xl font-black leading-none text-emerald-200">{step.number}</span>
                    </div>
                    <div>
