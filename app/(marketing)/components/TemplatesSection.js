...
const TEMPLATES = [
  {
    ...
    bg: ["#667eea", "#764ba2"], pattern: "grid",
    badge: "PREMIUM", badgeBg: "rgba(255,255,255,.2)", badgeClr: "#fff", accent: "rgba(255,255,255,.85)",
    tooltip: { couleurs: ["#667eea", "#764ba2"], police: "DM Sans Bold", ideal: "Marketing, business, formations" },
  },
  {
    id: "luxe", label: "Luxe",
    bg: ["#1a1a1a", "#3d2817"], pattern: "frame",
    badge: "LUXE", badgeBg: "#d4af37", badgeClr: "#111", accent: "#d4af37", italic: true,
    tooltip: { couleurs: ["#1a1a1a", "#d4af37"], police: "Georgia Italic", ideal: "Coaching, personal branding, luxe" },
  },
  {
    id: "educatif", label: "Éducatif",
    bg: ["#0f766e", "#14b8a6"], pattern: "dots",
    badge: "FORMATION", badgeBg: "rgba(255,255,255,.2)", badgeClr: "#fff", accent: "rgba(255,255,255,.85)",
    tooltip: { couleurs: ["#0f766e", "#14b8a6"], police: "DM Sans", ideal: "Formations, tutoriels, guides tech" },
  },
  {
    id: "energie", label: "Énergique",
    bg: ["#f97316", "#dc2626"], pattern: "stripes",
    badge: "BOOST", badgeBg: "rgba(255,255,255,.2)", badgeClr: "#fff", accent: "rgba(255,255,255,.85)",
    tooltip: { couleurs: ["#f97316", "#dc2626"], police: "DM Sans ExtraBold", ideal: "Sport, motivation, dev personnel" },
  },
  {
    id: "minimal", label: "Minimal",
    bg: ["#ffffff", "#f8fafc"], pattern: "border", darkText: true,
    badge: "GUIDE", badgeBg: "#f1f5f9", badgeClr: "#64748b", accent: "#1e293b",
    tooltip: { couleurs: ["#ffffff", "#1e293b"], police: "DM Sans Light", ideal: "Essais, philosophie, minimalisme" },
  },
  {
    id: "creative", label: "Créatif",
    bg: ["#a855f7", "#ec4899"], pattern: "blobs",
    badge: "CREATIF", badgeBg: "rgba(255,255,255,.2)", badgeClr: "#fff", accent: "rgba(255,255,255,.85)",
    tooltip: { couleurs: ["#a855f7", "#ec4899"], police: "DM Sans", ideal: "Créativité, design, art, culture" },
  },
  {
    id: "tech", label: "Tech",
    bg: ["#0a0e27", "#1e3a8a"], pattern: "code",
    badge: "TECH", badgeBg: "transparent", badgeClr: "#00d4ff", accent: "#00d4ff", border: "#00d4ff",
    tooltip: { couleurs: ["#0a0e27", "#00d4ff"], police: "DM Sans Mono", ideal: "IA, cybersécurité, crypto, dev" },
  },
  {
    id: "afrique", label: "Afrique",
    bg: ["#78350f", "#d97706"], pattern: "kente",
    badge: "AFRIQUE", badgeBg: "rgba(255,255,255,.2)", badgeClr: "#fff", accent: "#fbbf24",
    tooltip: { couleurs: ["#78350f", "#fbbf24"], police: "DM Sans Bold", ideal: "Entrepreneuriat africain, culture" },
  },
  {
    id: "corporate", label: "Corporate",
    bg: ["#1e40af", "#3b82f6"], pattern: "bars",
    badge: "BUSINESS", badgeBg: "rgba(255,255,255,.2)", badgeClr: "#fff", accent: "rgba(255,255,255,.85)",
    tooltip: { couleurs: ["#1e40af", "#3b82f6"], police: "DM Sans SemiBold", ideal: "B2B, management, stratégie" },
  },
  {
    id: "wellness", label: "Wellness",
    bg: ["#f3e8ff", "#c4b5fd"], pattern: "soft", darkText: true,
    badge: "BIEN-ETRE", badgeBg: "rgba(139,92,246,.15)", badgeClr: "#5b21b6", accent: "#7c3aed",
    tooltip: { couleurs: ["#f3e8ff", "#7c3aed"], police: "DM Sans Light", ideal: "Méditation, santé mentale, yoga" },
  },
  {
    id: "retro", label: "Rétro",
    bg: ["#92400e", "#b45309"], pattern: "lines",
    badge: "VINTAGE", badgeBg: "transparent", badgeClr: "#fbbf24", accent: "#fbbf24", border: "#fbbf24", italic: true,
    tooltip: { couleurs: ["#92400e", "#fbbf24"], police: "Georgia Italic", ideal: "Récits, mémoires, histoire, culture" },
  },
  {
    id: "nature", label: "Nature",
    bg: ["#166534", "#15803d"], pattern: "leaves",
    badge: "NATURE", badgeBg: "rgba(255,255,255,.2)", badgeClr: "#fff", accent: "rgba(255,255,255,.85)",
    tooltip: { couleurs: ["#166534", "#15803d"], police: "DM Sans", ideal: "Bien-être, écologie, alimentation" },
  },
];
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={W} height={H} viewBox={`0 0 ${W} ${H}`}>
      ...
      <g clipPath={`url(#cp${uid})`}>
        ...
        <rect x="10" y="11" width={Math.min(t.badge.replace(/[^\x00-\x7F]/g, "xx").length * 5.2 + 12, W - 20)} height="14" rx="7"
          fill={t.badgeBg} stroke={t.border || "none"} strokeWidth={t.border ? 0.8 : 0}/>
        <text x="16" y="21" fontFamily="DM Sans,sans-serif" fontSize="6" fontWeight="700"
          fill={t.badgeClr} letterSpacing=".3">{t.badge}</text>
        {lines.map((line, i) => (
          <text key={i} x="10" y={46 + i * 15} fontFamily={ff} fontSize={12}
            fontWeight="800" fontStyle={t.italic ? "italic" : "normal"} fill={tc}>{line}</text>
        ))}
        <rect x="10" y={46 + lines.length * 15 + 4} width={W * 0.48} height="1.8" rx="1" fill={t.accent}/>
        {[0,1,2].map(i => (
          <rect key={i} x="10" y={46 + lines.length * 15 + 13 + i * 7}
            width={W * (.32 + (i % 3) * .13)} height="1.3" rx="1" fill="rgba(255,255,255,.11)"/>
        ))}
...
function Tooltip({ t, visible }) {
  ...
  return (
    <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 z-50 w-52 pointer-events-none">
      <div className="rounded-2xl p-4 shadow-2xl text-left border border-[#C8BFB0]" style={{ background: "#F5F2ED" }}>
        ...
        <div className="flex gap-2 mb-3">
          {t.tooltip.couleurs.map((c, i) => (
            <div key={i} className="flex items-center gap-1.5">
              <div className="w-4 h-4 rounded-full border border-[#C8BFB0] flex-shrink-0" style={{ background: c }}/>
      ...
      <div className="absolute left-1/2 -translate-x-1/2 top-full w-0 h-0 border-l-[7px] border-r-[7px] border-t-[7px] border-l-transparent border-r-transparent border-t-[#C8BFB0]"/>
    </div>
  );
}
...
export default function TemplatesSection() {
  ...
  return (
    <section className="relative pt-16 pb-8 lg:py-24 overflow-hidden w-full max-w-full" style={{ background: "#F5F2ED" }}>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 lg:mb-16 pb-10 border-b border-[#C8BFB0]">
          <p className="text-xs font-black uppercase tracking-[0.3em] text-slate-400 mb-3">
            {TEMPLATES.length} Templates inclus
          </p>
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black text-slate-900 tracking-tight leading-[0.92]">
              Un design pro pour<br />
              <span className="text-blue-500">chaque sujet</span>
            </h2>
            <p className="text-slate-500 text-base sm:max-w-xs leading-relaxed">
              Clique un template pour voir les détails. Tous inclus dans chaque plan.
            </p>
          </div>
        </div>

        {/* Grille — scroll horizontal mobile */}
        <div className="mb-4 lg:mb-10">

          {/* Mobile */}
          <div className="overflow-hidden w-full">
            <div className="flex gap-3 overflow-x-auto pb-3 lg:hidden scrollbar-hide px-5"
              style={{ scrollSnapType: "x mandatory", WebkitOverflowScrolling: "touch" }}>
              {TEMPLATES.map((t, i) => (
                <div key={t.id} className="flex-shrink-0 flex flex-col items-center gap-2 relative"
                ...
                >
                  ...
                  <button
                    onClick={() => { setSelected(t.id); setModal(t); }}
                    className={`relative w-full rounded-xl overflow-hidden transition-all duration-200 border-2
                      ${selected === t.id
                        ? "border-slate-900 shadow-lg"
                        : "border-[#C8BFB0] hover:border-slate-400"}`}
                  >
                    <CoverSVG t={t} W={160} H={210} uid={`m${i}`}/>
                    {selected === t.id && (
                      <div className="absolute top-2 right-2 w-5 h-5 rounded-full bg-slate-900 flex items-center justify-center shadow-sm">
                  ...
                  <span className={`text-[10px] font-black uppercase tracking-widest transition-colors ${selected === t.id ? "text-slate-900" : "text-slate-400"}`}>
                    {t.label}
                  </span>
                </div>
              ))}
          ...
          <div className="hidden lg:grid grid-cols-6 gap-3">
            {TEMPLATES.map((t, i) => (
              <div key={t.id} className="relative flex flex-col items-center gap-2"
                onMouseEnter={() => setHovered(t.id)}
                onMouseLeave={() => setHovered(null)}
              >
                <Tooltip t={t} visible={hovered === t.id}/>
                <button
                  onClick={() => { setSelected(t.id); setModal(t); }}
                  className={`relative w-full rounded-xl overflow-hidden transition-all duration-200 border-2 group
                    ${selected === t.id
                      ? "border-slate-900 shadow-lg scale-[1.04]"
                      : "border-[#C8BFB0] hover:border-slate-400 hover:shadow-md hover:-translate-y-1"}`}
                >
        ...
        {/* Preview sélectionné — desktop */}
        {selectedT && (
          <div className="hidden lg:flex rounded-2xl border border-[#C8BFB0] bg-white p-6 lg:p-10 flex-col lg:flex-row items-center gap-8 lg:gap-14 relative overflow-hidden">
            ...
            <div className="flex-shrink-0 relative z-10">
              <div className="relative" style={{ perspective: "900px" }}>
                ...
                <div className="absolute top-2 right-[-10px] bottom-2 w-3 bg-[#E8E2D9] rounded-r-sm"/>
                <div className="absolute top-4 right-[-16px] bottom-4 w-2 bg-[#D6CFC4] rounded-r-sm"/>
              </div>
            </div>
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    {selectedT.tooltip.couleurs.map((c, i) => (
                      <div key={i} className="flex items-center gap-1.5">
                        <div className="w-6 h-6 rounded-full border-2 border-[#C8BFB0] shadow-sm" style={{ background: c }}/>
        ...
        <div className="hidden lg:block text-center mt-8">
          <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">
            Tous les templates inclus dans chaque plan.{" "}
            <Link href="/auth/register" className="text-slate-900 hover:text-slate-600 underline underline-offset-4 transition-colors">
      ...
      {modal && (
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-5"
          ...
          <div className="rounded-2xl overflow-hidden w-full max-w-sm shadow-2xl border border-[#C8BFB0] relative"
            style={{ background: "#F5F2ED", animation: "popIn .2s ease" }}
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between px-5 py-4 border-b border-[#C8BFB0]">
                <div>
                ...
                <button onClick={() => setModal(null)} className="w-8 h-8 rounded-lg bg-white border border-[#C8BFB0] hover:border-slate-400 flex items-center justify-center transition-all">
              ...
              <div className="px-5 py-5 border-t border-[#C8BFB0] space-y-4">
                <div className="flex gap-6">
                  <div>
                    <p className="text-[9px] font-black text-slate-400 uppercase tracking-[0.2em] mb-2">Couleurs</p>
                    <div className="flex gap-1.5">
                      {modal.tooltip.couleurs.map((c, i) => (
                        <div key={i} className="w-5 h-5 rounded-full border border-[#C8BFB0] shadow-sm" style={{ background: c }}/>
                      ))}
                    </div>
                  </div>
                  <div>
                ...
                <div className="w-full h-px bg-[#C8BFB0]" />
                <Link href="/auth/register"
                  className="flex items-center justify-center gap-2 w-full py-3.5 bg-slate-900 hover:bg-slate-800 text-white font-black text-xs uppercase tracking-widest rounded-xl transition-all">
                  Utiliser ce template
                  <ArrowRight className="w-4 h-4"/>
                </Link>
              </div>
