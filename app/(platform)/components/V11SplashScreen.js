...
const STORAGE_KEY = "bookzy_v11_venus_seen";

export default function V11SplashScreen({ user }) {
        ...
        <div className="relative bg-[#0A0A0A] rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
          ...
          <div className="relative z-10 p-8 sm:p-10">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-white/5 border border-white/10 rounded-full mb-8">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.3em] text-white/40">V1.1 Venus</span>
            </div>

            {/* Titre */}
            <h1 className="font-black text-white leading-[0.92] tracking-tight mb-6"
              style={{ fontSize: "clamp(2rem, 6vw, 3rem)" }}>
              Venus vient<br />d'atterrir.<br />
              <span className="text-white/30">Tout a changé.</span>
            </h1>

            {/* Texte */}
            <p className="text-white/50 text-sm leading-relaxed mb-8 max-w-sm">
              On ne s'est pas arrêtés. Nouvelles fonctionnalités, flux repensé, outils puissants — Bookzy devient la machine qui génère des ebooks ultra-pro pour vous.
            </p>

            {/* Features pills */}
            <div className="flex flex-wrap gap-2 mb-10">
              {["Smart Shop", "Niche Hunter", "Crédits", "Génération repensée", "Suggestions"].map(f => (
