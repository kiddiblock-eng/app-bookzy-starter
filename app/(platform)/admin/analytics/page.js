...
const PerformanceAreaChart = dynamic(
  () => import("./_charts/AnalyticsCharts").then((m) => m.PerformanceAreaChart),
  { ssr: false, loading: () => <div className="w-full h-[350px] bg-neutral-100 rounded-xl animate-pulse" /> }
);
const TemplatesPieChart = dynamic(
  () => import("./_charts/AnalyticsCharts").then((m) => m.TemplatesPieChart),
      ...
      <div className="bg-white border border-neutral-200 rounded-xl p-6">
        ...
        <div className="h-[350px] w-full">
           {combinedDaily.length === 0 ? (
              ...
              <PerformanceAreaChart data={combinedDaily} />
           )}
        </div>
      </div>
            ...
            {templatesStats.length === 0 ? (
               ...
               <div className="flex items-center">
                  <div className="h-[250px] w-1/2">
                     <TemplatesPieChart data={templatesStats} />
                  </div>
