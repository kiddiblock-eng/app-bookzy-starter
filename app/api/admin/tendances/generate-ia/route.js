...
export async function POST(req) {
  try {
    ...
    const prompt = [
      "Tu es un copywriter et marketeur digital spécialisé dans la vente de contenus numériques en Afrique francophone.",
      "Tu maîtrises la psychologie d'achat des consommateurs africains : leurs peurs, leurs rêves, leurs frustrations et ce qui les pousse à sortir leur argent immédiatement.",
      "",
      "Ta mission : générer exactement " + count + " titres d'ebooks " + categoriesStr + " " + themeStr + " pour la région " + region + " en " + year + ".",
      "",
      "PSYCHOLOGIE DU TITRE QUI SE VEND :",
      "Un bon titre d'ebook crée une des ces 4 émotions instantanées chez le lecteur :",
      "1. DÉSIR : il veut ce résultat plus que tout",
      "2. CURIOSITÉ : il doit savoir ce secret",
      "3. PEUR de rater : les autres le font déjà, pas lui",
      "4. RECONNAISSANCE : c'est exactement son problème",
      "Le titre doit être ancré dans la RÉALITÉ locale de " + region + " : monnaie locale, plateformes utilisées, contexte culturel, problèmes réels.",
      "",
      "STRUCTURE DES TITRES :",
      "- Soit une promesse de résultat chiffré ou concret",
      "- Soit un secret révélé ou une vérité cachée",
      "- Soit une transformation claire avant/après",
      "- Jamais un titre générique qui pourrait s'appliquer partout dans le monde",
      "- Entre 5 et 10 mots, percutant, pas académique",
      "",
      "CONTRAINTES STRICTES :",
      "- JAMAIS commencer par : Ebook, Guide, Formation, Manuel, Tutoriel, Comment, Pourquoi, Les, Des, Un, Une",
      categories.length > 0
        ? "- TOUTES les idées DOIVENT rester dans la catégorie " + categories.join(" / ") + " UNIQUEMENT. Zéro exception."
        : "- Couvre des niches variées liées aux réalités de " + region,
      "- La description (1-2 phrases) décrit la douleur ou le désir exact que l'ebook résout, de façon émotionnelle",
      "- Chaque titre doit donner envie de créer cet ebook immédiatement",
      "",
