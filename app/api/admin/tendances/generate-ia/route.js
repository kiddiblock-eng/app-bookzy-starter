...
export async function POST(req) {
  try {
    ...
    const prompt = [
      "Tu es un expert en création de contenus digitaux qui se VENDENT VRAIMENT en Afrique francophone.",
      "Tu connais parfaitement les douleurs, aspirations et réalités du quotidien africain : argent mobile, chômage, entrepreneuriat informel, réseaux sociaux, famille, religion, immigration, beauté, santé naturelle.",
      "",
      "Génère exactement " + count + " idées d'ebooks ultra-vendables " + categoriesStr + " " + themeStr + " pour la région " + region + " en " + year + ".",
      "",
      "CRITÈRES D'UNE BONNE IDÉE :",
      "- Elle répond à un VRAI problème que les gens cherchent à résoudre MAINTENANT (gagner de l'argent, trouver un job, maigrir, séduire, réussir au bac, partir en Europe, créer sa boutique, guérir une maladie courante, etc.)",
      "- Elle est SPÉCIFIQUE à l'Afrique ou aux Africains en diaspora (pas générique mondial)",
      "- Le titre donne ENVIE d'acheter immédiatement — comme une promesse claire et désirable",
      "- Elle est monétisable entre 1 000 et 15 000 FCFA",
      "",
      "EXEMPLES DE BONS TITRES (inspire-toi de ce style) :",
      "- 'Gagner 300 000 FCFA avec WhatsApp'",
      "- 'Obtenir le visa Schengen depuis l\\'Afrique'",
      "- 'Lancer sa boutique en ligne sans capital'",
      "- 'Perdre du ventre avec des aliments africains'",
      "- 'Réussir le BEPC sans cours particuliers'",
      "- 'Investir en bourse depuis Abidjan'",
      "- 'Créer son savon naturel et le vendre'",
      "- 'Séduire et garder un homme de valeur'",
      "- 'Construire sa maison avec un petit budget'",
      "- 'Devenir assistant virtuel depuis l\\'Afrique'",
      "",
      "RÈGLES ABSOLUES :",
      "- Le titre doit être une PROMESSE CONCRÈTE, jamais vague",
      "- JAMAIS commencer par : Ebook, Guide, Formation, Manuel, Tutoriel, Comment, Pourquoi, Les, Des",
      "- Entre 4 et 8 mots par titre",
      "- La description explique la douleur ou le désir visé, en 1-2 phrases percutantes",
      "- Variété de niches : mix entre argent, santé, amour, éducation, beauté, spiritualité, immigration",
      "",
      ...
      "",
      "Format JSON attendu pour chaque objet :",
      '{"title":"...","description":"...","emoji":"...","categories":["..."],"difficulty":"...","competition":"...","monetizationPotential":"...","monetizationMethods":["Ebook"],"growth":75,"searches":50000,"potential":5000,"isHot":true,"isRising":true,"isProfitable":true,"period":"Mois","tags":["..."],"gradient":"from-orange-500 to-red-500","priority":80}',
      "",
