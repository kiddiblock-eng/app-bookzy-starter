...
export async function dbConnect() {
  ...
  if (!cached.promise) {
    const opts = {
      ...
      // Render = process long (pas serverless) : un pool de 1 sérialisait TOUTES
      // les requêtes (gros goulot, ex. dashboard qui en lance 10). Pool 10 = vraie
      // concurrence. Atlas autorise largement ce nombre de connexions.
      maxPoolSize: 10,
      minPoolSize: 2,
