  ...
  let bodyHTML = `
    ...
    ${chaptersData.map((ch, idx) => `
        <div class="content-page start-chapter">
            ...
            <div class="section-content chapter-content">${ch.content}</div>
        </div>
    `).join('')}
    <div class="content-page start-chapter">
  ...
  const finalCSS = `
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .section-content h2::before {
        content: ""; display: inline-block; width: 10px; height: 24px;
        background: ${theme.secondary}; margin-right: 15px; border-radius: 4px;
    }
    .chapter-content > h2:first-child { display: none; }
    .section-content h3 {
