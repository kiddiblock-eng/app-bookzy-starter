...
export const OFFERS = {
  decouverte: {
    id: "decouverte",
    label: "Découverte",
    tagline: "Lance-toi et publie tes premiers ebooks prêts à vendre",
    priceFcfa: 4500,
    ebooks: 2,
    unlocksTools: false,
  },
  createur: {
    id: "createur",
    label: "Créateur",
    tagline: "Crée une vraie collection et débloque tous les outils pour vendre plus",
    priceFcfa: 7500,
    ebooks: 5,
    unlocksTools: true,
    recommended: true,
  ...
  pro: {
    id: "pro",
    label: "Pro",
    tagline: "Produis en volume et transforme tes ebooks en vrai business",
    priceFcfa: 12500,
    ebooks: 15,
    unlocksTools: true,
  },
