...
const RAW = [
  ...
  { nom: "Maroc", prep: "au", mm: ["carte bancaire", "M-Wallet", "CashPlus"], zone: "afrique", note: "un grand marché digital du Maghreb" },
  { nom: "Tunisie", prep: "en", mm: ["carte bancaire", "D17", "e-Dinar"], zone: "afrique", note: "où le paiement en ligne se démocratise" },
  { nom: "Algérie", prep: "en", mm: ["carte Edahabia", "carte CIB", "BaridiMob"], zone: "afrique", note: "un vaste marché en pleine digitalisation" },
  { nom: "Mauritanie", prep: "en", mm: ["Bankily", "Sedad", "Masrvi"], zone: "afrique", note: "où le mobile money progresse vite" },
  { nom: "Tchad", prep: "au", mm: ["Airtel Money", "Tigo Cash"], zone: "afrique", note: "un marché émergent du digital" },
  { nom: "Rwanda", prep: "au", mm: ["MTN MoMo", "Airtel Money"], zone: "afrique", note: "réputé pour son économie numérique" },
  { nom: "Burundi", prep: "au", mm: ["Lumicash", "EcoCash"], zone: "afrique", note: "où le paiement mobile se développe" },
  { nom: "Centrafrique", prep: "en", mm: ["Orange Money", "Moov Money"], zone: "afrique", note: "un marché digital en construction" },
  { nom: "Maurice", prep: "à", mm: ["carte bancaire", "Juice", "MyT Money"], zone: "afrique", note: "un marché digital mature de l'océan Indien" },
  { nom: "Djibouti", prep: "à", mm: ["D-Money", "carte bancaire"], zone: "afrique", note: "un carrefour commercial en digitalisation" },
  { nom: "Suisse", prep: "en", mm: ["carte bancaire", "TWINT", "PayPal"], zone: "diaspora", note: "auprès de la diaspora francophone" },
  { nom: "Luxembourg", prep: "au", mm: ["carte bancaire", "Payconiq", "PayPal"], zone: "diaspora", note: "auprès de la communauté francophone" },
  { nom: "États-Unis", prep: "aux", mm: ["carte bancaire", "PayPal", "Cash App"], zone: "diaspora", note: "auprès de la diaspora africaine" },
  { nom: "Haïti", prep: "en", mm: ["MonCash", "carte bancaire"], zone: "diaspora", note: "un marché francophone de la Caraïbe" },
];
